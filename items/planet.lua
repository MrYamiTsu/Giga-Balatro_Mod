...
SMODS.Consumable{ --AstralMercury
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Mercury'}}
        end
        return {
            vars = {
...
SMODS.Consumable{ --AstralVenus
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Venus'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralEarth
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Earth'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralMars
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Mars'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralJupiter
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Jupiter'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralSaturn
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Saturn'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralUranus
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Uranus'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralNeptune
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Neptune'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralPluto
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Pluto'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralPlanetX
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Planet X'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralCeres
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Ceres'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralEris
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Eris'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralTitania
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Titania'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type].level,
...
SMODS.Consumable{ --AstralSylvia
    ...
    loc_vars = function(self, info_queue, card)
        if G.SETTINGS.paused then
            info_queue[#info_queue+1] = {set = 'Other', key = 'giga_astral_chance', vars = {G.GAME.giga.astral_chance[1] / G.GAME.giga.astral_chance[2] * 100, 'Sylvia'}}
        end
        return {
            vars = {
                G.GAME.hands[card.ability.extra.hand_type1].level,

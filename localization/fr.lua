    ...
    descriptions = {
        ...
        Voucher={
            v_giga_newMenu = {
                name = 'Nouveau Menu',
                text = {
                    'Paquet Restaurant ont',
                    '{C:attention}#1#{} choix de plus'
                }
            },
            v_giga_foodTruck = {
                name = 'Camion-restaurant',
                text = {
                    'Cartes de {V:1}Repas{} peuvent',
                    'apparaître dans le {C:attention}magasin{}'
                }
            },
            v_giga_homeDelivery = {
                name = 'Livraison à domicile',
                text = {
                    'Cartes de {V:1}Repas{} apparaissent',
                    '{C:attention}2,5X{} plus fréquemment'
                }
            }
        },
        ["Content Set"] = {
            set_giga_megaLegendary = {
                name = "Mega Legendaire",
            }   
        }
    },
    misc = {
        ...
        collabs={},
        dictionary={
            k_restaurant_pack = "Paquet Restaurant",
            b_giga_custom_menu_card = "Désactiver le Joker personnalisé du menu"
        },
        high_scores={},
        labels={},
